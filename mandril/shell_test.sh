...
python3 mandril/test_mandril.py --output-folder 'banditk5n10/rand_from_rand_best_5' --expert-type rand_from_rand_best --expert-args '{"max_k": 5}'

echo ">> Mandril with random from best random k=3:"
python3 mandril/test_mandril.py --output-folder 'banditk5n10/rand_from_rand_best_3' --expert-type rand_from_rand_best --expert-args '{"max_k": 3}'

echo ">> Mandril with random from best random k=2:"
python3 mandril/test_mandril.py --output-folder 'banditk5n10/rand_from_rand_best_2' --expert-type rand_from_rand_best --expert-args '{"max_k": 2}'

echo ">> Mandril with random from best random k=4:"
python3 mandril/test_mandril.py --output-folder 'banditk5n10/rand_from_rand_best_4' --expert-type rand_from_rand_best --expert-args '{"max_k": 4}'
